...
export default function Legacy({ isPage = false }) {
    ...
    return (
        <section className={`${isPage ? "pt-32 min-h-screen bg-gray-50/50" : "py-24 bg-white"} pb-24 px-6 relative overflow-hidden`}>
            <div className={`max-w-6xl mx-auto ${isPage ? "mt-12" : ""} mb-16 relative z-10`}>
                ...
                <div className="text-center mb-16 md:mb-12">
                    ...
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.6, delay: isPage ? 0.2 : 0.2 }}
